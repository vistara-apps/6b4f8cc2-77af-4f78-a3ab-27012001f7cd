    ...
    <div className="card hover:bg-white/15 transition-all duration-200">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="text-center">
          ...
          <div className="text-white font-semibold">{draw.soldTickets}</div>
        ...
        <div className="text-center">
          ...
          <div className="text-white font-semibold">{formatCurrency(draw.ticketPrice)}</div>
          <div className="text-white/60 text-xs">Per Ticket</div>
        </div>
        
        <div className="text-center">
          <div className="flex items-center justify-center w-10 h-10 bg-green-500/20 rounded-lg mb-2 mx-auto">
            <Users size={18} className="text-green-400" />
          </div>
          <div className="text-white font-semibold">{draw.maxTickets}</div>
